...
URL = "https://mrblust.onrender.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://mrblust.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://mrblust.onrender.com/".format(FQDN)
else:
    URL = "https://mrblust.onrender.com/".format(FQDN)
